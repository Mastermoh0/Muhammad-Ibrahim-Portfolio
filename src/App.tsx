      ...
      <motion.div variants={fadeInUp} className="rounded-[40px] overflow-hidden shadow-2xl relative aspect-[4/5]">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 flex flex-col items-center text-center">
          ...
          <div className="flex items-center gap-4 text-white">
            ...
            <motion.a whileHover={{ scale: 1.1 }} href="https://www.linkedin.com/in/muhammad-al-amin-ibrahim/" target="_blank" rel="noopener noreferrer" className="p-2 border border-white/20 rounded-full hover:bg-white/10 transition-colors backdrop-blur-sm">
